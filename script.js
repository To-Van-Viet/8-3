...
const specialGreetings = {
    ...
    "co be bat ca": "Chúc em có một ngày 8/3 thật vui vẻ, tràn đầy năng lượng và hạnh phúc. Mong em luôn xinh đẹp, tự tin, thành công trong mọi việc và được yêu thương thật nhiều mỗi ngày! Chúc em cố gắng học tập tốt để đủ điểm để vào trường đại học em mong muốn (cảm ơn anh thì cho xin tấm ảnh của e ik hẹ hẹ hẹ)",
    ...
    "bao trang":"Chúc 'em bé' có một ngày 8/3 thật vui vẻ, đáng nhớ và tràn ngập tiếng cười. Mong em luôn hồn nhiên, xinh xắn, học giỏi và ngày càng tự tin hơn nhé! 🌷💐(Chúc em ăn mau chóng lớn sớm cao hơn hẹ hẹ )(Muốn cảm ơn anh cho xin tấm ảnh ik :)))",
