...
const specialGreetings = {
    ...
    "bao trang":"Chúc 'em bé' có một ngày 8/3 thật vui vẻ, đáng nhớ và tràn ngập tiếng cười. Mong em luôn hồn nhiên, xinh xắn, học giỏi và ngày càng tự tin hơn nhé! 🌷💐(Muốn cảm ơn anh cho xin tấm ảnh ik :)))",
};
